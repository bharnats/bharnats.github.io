...
**Objective:** 
Create a Web Dashboard Report to show off the plots generated by the weather analysis project

Data is more powerful when we share it with others! I used HTML/CSS and created a visual dashboard to show off the weather analysis done in my previous project [Weather Analysis Plots](bharnats/API_Interactions-WeatherPy/Plots)
